...
if (isset($_POST["count"]))
{
  ...
  if (!is_null($idUser))
  {
    $req = $bdd->prepare("INSERT INTO ordonance(idMedecin, idUser, dateCrea, useTime) VALUES(:idMed, :idUser, NOW(), :useTime)");
    $req->execute(array(
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Ordonance</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="content">
          ...
          <form id="listMedicForm" action="/medecin/ordonance.php" method="post">
