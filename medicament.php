...
<html lang="fr">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Médicament</span>
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
      <div class="content"><br>
        <h3>Ajouter un médicament</h3>
		    <form action="script/sendmedicament.php" method="post"><br>
			    Médicament : <input type="text" required placeholder="Nom du médicament" name="medicament"><br><br>
			    Description : <input type="text" name="description" required placeholder="Description du médicament" style="width: 50em; height: 10em"><br><br>
			    Quantité d'utilisation : <input type="text" requires placeholder="Nombre de dose du médicament" name="dose"><br><br>
			    <input type="submit" value="Ajouter">
		    </form>
    		<br><br>
    		<h3>Supprimer un médicament</h3>
    		<br>
    		<form action="script/delmedicament.php" method="post"><br>
    			Médicament : <input type="text" id="delMedic" required placeholder="Nom du médicament" name="medicament"><br><br>
    			<input type="submit" value="Supprimer" onclick="script/delmedicament.php">
    		</form>
    		<br>
    		<table class="table-fill">
    			<thead>
    				<tr>
    					...
    					<th class="text-left">Quantité d'utilisation</th>
    				</tr>
    			</thead>
    		<tbody class="table-hover">
    		<?php
    			$raw = $bdd->query('SELECT * FROM medicament');
  ...
  <script src="/js/medicament.js"></script>
  </body>
</html>
