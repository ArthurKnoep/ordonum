...
{
  header('Location:/medecin/ordo-menu');
  //include("medecin/ordonance.php");
}
?>
<!DOCTYPE html>
<html lang="fr">
  ...
  <body>
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Ordonnance</span>
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            ...
            <a class="mdl-navigation__link" href=""><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true" style="padding-right: 0.3em;"></i>Ordonnance</a>
			...
			<?php
			if (isset($_SESSION) AND ($_SESSION['typeUser'] == 2 OR $_SESSION['typeUser'] == 3))
			{
	...
	{
		include("user/ordonnance.php");
	}
  if ($_SESSION['typeUser'] == 2)
	{
    header('Location:/medecin/ordoMenu.php');
		//include("medecin/ordonance.php");
	}
  if ($_SESSION['typeUser'] == 3)
  {
    include("pharmacien/ordonance.php");
  }
	?>
	</main>
  </body>
