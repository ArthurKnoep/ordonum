...
if (isset($_POST["to"]) && isset($_POST["msg"])) {
  $req = $bdd->prepare('INSERT INTO message (idUser, content, dateMsg, toUser) VALUES(:idUser, :content, NOW(), :toUser)');
  $req->execute(array(
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="content">
          <?php
            ...
            $donnees = $req->fetch();
          ?>
          <h4>Nouveaux message à <?php echo $donnees["firstName"] . ' ' . $donnees['lastName']; ?></h4>
          <form action="/message/newConv.php" method="post" class="new-conv">
