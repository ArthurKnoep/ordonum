      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="content">
          ...
          <i class="fa <?php
            ...
            ?>" aria-hidden="true"></i>
          <?php
            echo $_SESSION["firstName"] . " " . $_SESSION["lastName"] . "</h4>";
            echo "<br><br /><u>Date de naissance </u>: " . $_SESSION["dateBirth"];
            echo "<br><br /><u>Mail </u>: " . $_SESSION["mail"];
            echo "<br><br /><u>UUID </u>: " . $_SESSION["uuidUser"] . "</p>";
            }
          ?>
        </div>
	     </main>
